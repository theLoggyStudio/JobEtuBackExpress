 ...
 * Modifiez `current` pour refléter test vs production (logs, défauts, etc.).
 * `STORAGE_DRIVER` dans l’environnement reste prioritaire. Sans variable : en `test`, défaut = `memory` (RAM).
 */
